...
public class DealDamageEventArgs : EventArgs
{
    ...
    public static byte[] Serialize(object obj)
    {
        ...
        return JoinBytes(targetViewIDBytes, damageOwnerViewID, damageOwnerPositionXBytes, damageOwnerPositionYBytes, damageOwnerPositionZBytes, takeDownValueBytes,verticalForce, horizontalForce);
